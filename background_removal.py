...
mountain = cv2.imread(r'C:\Users\arnav\arnavcoding\PRO-C121-Project-Boilerplate-main\mount everest.jpg')
...
while True:
    ...
    if status:
        ...
        # bitwise and operation to extract background / mountain
